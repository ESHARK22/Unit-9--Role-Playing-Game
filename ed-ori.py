...
#-----------------------WEAPON STATS--------------------------------------------------------------------------------------
van_der_graaf_generator=["VAN DER GRAAF GENERATOR",5,10,4,2,7,"swing","send forth a beam of electricity bolts from","release of devastating small field of electricity from","(1)"]#ENEMY  weapon ATTACK stats
